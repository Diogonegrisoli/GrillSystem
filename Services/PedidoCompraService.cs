...
namespace GrillSystem.Services
{
    public class PedidoCompraService
    {
        ...
        public async Task<PedidoCompra> Update(int id, [FromBody] PedidoCompraUpdateDto data)
        {
            ...
            {
                throw new Exception("Não foi possível atualizar o pedido de compra.", ex);
            }
        }

        public async Task<PedidoCompra> Delete(int id)
        {
            try
            {
                var pedidoCompra = await _context.PedidosCompra.FirstOrDefaultAsync(x => x.Id == id);
            ...
            {
                throw new Exception("Não foi possível deletar o pedido de compra.", ex);
            }
        }
    }
}
