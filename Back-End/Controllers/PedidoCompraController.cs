...
namespace GrillSystem.Controllers
{
    ...
    public class PedidoCompraController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ICollection<PedidoCompra>> Get()
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<PedidoCompra>> Create([FromBody] PedidoCompraDto data)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<PedidoCompra>> Update(int id, PedidoCompraUpdateDto data)
        {
            try
            {
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<PedidoCompra>> Delete(int id)
        {
            try
            {
